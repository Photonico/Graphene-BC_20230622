    ...
    for supplot_index in range(2):
        ...
        for _, data in enumerate(dataset):
            ...
            if supplot_index == 0:
                ...
                inplane_absorption_full = com_refractive(data[1]["density_xx_real"],data[1]["density_xx_imag"])
            ...
            # Outplane
                ...
                outplane_absorption_full = com_refractive(data[1]["density_zz_real"],data[1]["density_zz_imag"])
