...
plot_kpoints_free_energy("BC₃","1_Kpoints/BC3/kpoints_energy.dat","X", 3, 23)

#%% Graphene - BC3: Hollow

summarize_kpoints_free_energy("1_Kpoints/Graphene_BC3_Hollow")

plot_kpoints_free_energy("Graphene-BC₃: Hollow","1_Kpoints/Graphene_BC3_Hollow/kpoints_energy.dat","X", 5, 61, "violet")
