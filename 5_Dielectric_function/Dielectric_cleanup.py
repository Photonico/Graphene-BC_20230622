...
files_to_keep = [
    "INCAR", "KPOINTS", "KPOINTS_OPT", "POSCAR", "POTCAR", "WAVECAR", "vasp_gadi.sh", "vasp_artemis.sh", "vasp_gadi.sh", "vasp_usyd.sh", "Dielectric_cleanup.py"
]
