...
dos_BC3_K17 = extract_dos("4_PDoS_PBE/A_BC3_K17")
dos_BC3_K33 = extract_dos("4_PDoS_PBE/A_BC3_K33")
dos_BC3_K65 = extract_dos("4_PDoS_PBE/A_BC3_K65")
...
pdos_BC3 = extract_pdos("4_PDoS_PBE/A_BC3_K65")

plot_total_pdos("BC₃", 6, 10, "PBE", "total", pdos_BC3, "blue")

#%% Borophene DoS

dos_Borophene_K17 = extract_dos("4_PDoS_PBE/B_Borophene_K17")
dos_Borophene_K33 = extract_dos("4_PDoS_PBE/B_Borophene_K33")
dos_Borophene_K65 = extract_dos("4_PDoS_PBE/B_Borophene_K65")
...
pdos_Borophene = extract_pdos("4_PDoS_PBE/B_Borophene_K65")

plot_total_pdos("Borophene", 6, 10, "PBE", "total", pdos_Borophene, "blue")

#%% B₄C₃ DoS

dos_B4C3_K17 = extract_dos("4_PDoS_PBE/C_B4C3_K17")
dos_B4C3_K33 = extract_dos("4_PDoS_PBE/C_B4C3_K33")
dos_B4C3_K65 = extract_dos("4_PDoS_PBE/C_B4C3_K65")
...
pdos_B4C3 = extract_pdos("4_PDoS_PBE/C_B4C3_K65")

plot_total_pdos("B₄C₃", 6, 10, "PBE", "total", pdos_B4C3, "blue")

#%% Graphene DoS

dos_Graphene_K33 = extract_dos("4_PDoS_PBE/D_Graphene_K33")
dos_Graphene_K65 = extract_dos("4_PDoS_PBE/D_Graphene_K65")
dos_Graphene_K129 = extract_dos("4_PDoS_PBE/D_Graphene_K129")
...
pdos_Graphene = extract_pdos("4_PDoS_PBE/D_Graphene_K129")

plot_total_pdos("Graphene", 6, 1.25, "PBE", "total", pdos_Graphene, "blue")

#%% Graphene - BC₃: Hollow DoS

dos_E_K17 = extract_dos("4_PDoS_PBE/E_Graphene-BC3_Hollow_K17")
dos_E_K33 = extract_dos("4_PDoS_PBE/E_Graphene-BC3_Hollow_K33")
dos_E_K65 = extract_dos("4_PDoS_PBE/E_Graphene-BC3_Hollow_K65")
...
pdos_E = extract_pdos("4_PDoS_PBE/E_Graphene-BC3_Hollow_K65")

plot_total_pdos("Graphene-BC₃: Hollow", 6, 12, "PBE", "total", pdos_E, "blue")

#%% Graphene - Borophene: Top DoS

dos_F_K17 = extract_dos("4_PDoS_PBE/F_Graphene-Borophene_Top_K17")
dos_F_K33 = extract_dos("4_PDoS_PBE/F_Graphene-Borophene_Top_K33")
dos_F_K65 = extract_dos("4_PDoS_PBE/F_Graphene-Borophene_Top_K65")
...
pdos_F = extract_pdos("4_PDoS_PBE/F_Graphene-Borophene_Top_K65")

plot_total_pdos("Graphene-Borophene: Top", 6, 12, "PBE", "total", pdos_F, "blue")

#%% Graphene - B₄C₃: Top DoS

dos_G_K17 = extract_dos("4_PDoS_PBE/G_Graphene-B4C3_Top_K17")
dos_G_K33 = extract_dos("4_PDoS_PBE/G_Graphene-B4C3_Top_K33")
dos_G_K65 = extract_dos("4_PDoS_PBE/G_Graphene-B4C3_Top_K65")
...
pdos_G = extract_pdos("4_PDoS_PBE/G_Graphene-B4C3_Top_K65")
