...
for a_var in np.arange(start, end+step, step):
    ...
    for file_name in ["INCAR", "KPOINTS", "vasp_job.sh", "POTCAR"]:
    ...
    with open(os.path.join(dest_dir, "POSCAR"), "w") as f:
       ...
       -{a_1:.6f}    {a_2:.6f}    0.000000
        ...
        8
        Direct
        0.166666    0.333333    0.100000
        0.333333    0.166666    0.100000
        0.166666    0.833333    0.100000
        0.333333    0.666666    0.100000
        0.666666    0.333333    0.100000
        0.833333    0.166666    0.100000
        0.666666    0.833333    0.100000
        0.833333    0.666666    0.100000""")
